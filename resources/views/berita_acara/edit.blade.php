    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8 col-sm-12 bg-white custom-form">
                <form method="post" action="{{ url('berita_acara/' . $acara->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="berita_acara" name="berita_acara"
                            value="{{ $acara->berita_acara }}" placeholder="Berita Acara">
                    </div>
                    <div class="mb-3">
                        <label for="tanggal" class="form-label">Tanggal</label>
                        <input type="date" class="form-control" id="tanggal" name="tanggal"
                            value="{{ $acara->tanggal }}" placeholder="Tanggal">
                    </div>
                    <div class="mb-3">
