                ...
                <form method="post" action="{{ url('inventory/' . $inventory->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_barang" name="nama_barang"
                            value="{{ $inventory->nama_barang }}" placeholder="Nama Barang">
                    </div>
                    <div class="mb-3">
                        <label for="merk" class="form-label">Merk</label>
                        <input type="text" class="form-control" id="merk" name="merk"
                            value="{{ $inventory->merk }}" placeholder="Merk">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="no_inventaris" name="no_inventaris"
                            value="{{ $inventory->no_inventaris }}" placeholder="Nomor Inventaris">
                    </div>
                    <div class="mb-3">
                        <label for="jumlah" class="form-label">Jumlah</label>
                        <input type="text" class="form-control" id="jumlah" name="jumlah"
                            value="{{ $inventory->jumlah }}" placeholder="Jumlah">
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="tahun_pengadaan" class="form-label">Tahun</label>
                        <input type="text" class="form-control" id="tahun_pengadaan" name="tahun_pengadaan"
                            value="{{ $inventory->tahun_pengadaan }}" placeholder="Tahun Pengadaan">
                    </div>
                    <div class="mb-3">
                        <label for="keterangan" class="form-label">Keterangan</label>
                        <input type="text" class="form-control" id="keterangan" name="keterangan"
                            value="{{ $inventory->keterangan }}" placeholder="Keterangan">
                    </div>
                    <div class="mb-3">
                        <label for="kategori" class="form-label">Kategori</label>
                        <input type="text" class="form-control" id="kategori" name="kategori"
                            value="{{ $inventory->kategori }}" placeholder="kategori">
                        <div class="mb-3">
                            <label for="posisi" class="posisi">Letak barang</label>
                            <input type="text" class="form-control" id="posisi" name="posisi"
                                value="{{ $inventory->posisi }}" placeholder="Letak Barang">
                        </div>
                        <div class="mb-3">
